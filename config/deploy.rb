...
set :application, "jasonbutler42.com" #FIXME
...
set :scm, :git
set :repository,  "https://github.com/jasonbutler42/jasonbutler42.com.git" #FIXME
# set :scm, :subversion
...
set :local_path, "/workspace/jasonbutler42.com" #FIXME

# Use a remote cache to speed things up
set :deploy_via, :remote_cache
ssh_options[:user] = 'addtwops' #FIXME
...
set :local_domain, 'local.jasonbutler42.com' #FIXME
